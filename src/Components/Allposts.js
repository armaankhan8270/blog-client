...
const AllPosts = () => {
  ...
  const getData = async () => {
    try {
      const response = await axios.get(
        "https://blogserver-nml8.onrender.com/post"
      );
  ...
  const DeletePost = async (id) => {
    try {
      await axios.delete(`https://blogserver-nml8.onrender.com/post/${id}`);
          ...
          >
            ...
            >
              <img
                ...
                src={`https://blogserver-nml8.onrender.com/uploads/${blog.photo}`}
                alt={blog.title}
              />
